...
public class DomainExperiment {
    ...
    private VOEnvironment generateNewEnvironment() {
        ...
        envSet.maxResourceSpeed = 21;
        envSet.resourceLineNum = 30;
    ...
    private void setExperimentChanges(){
        //1
        
        //envSet.minResourceSpeed = 5;
        //envSet.minResourceSpeed = 7;
        //epc.priceMutationFactor = 0.0;
    }
