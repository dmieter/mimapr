...
public class DynamicHorizontSchedulerExperiment extends Experiment {
    ...
    protected void generateSpecialEvents(PriorityQueue<Event> events, VOEnvironment voe) {
        ...
        ComputingResourceLine newLine = new ComputingResourceLine(voe.resourceLines.get(0));
        newLine.id = 3632783;
        ResourceEvent reSTART = new ResourceEvent(400, newLine, ResourceEvent.ADD);
        
        ComputingResourceLine changedLine = new ComputingResourceLine(voe.resourceLines.get(1));
        changedLine.resourceType.setPerformance(10); /* speed of all resoyrceType*/
        changedLine.resourceType = new ComputingNode("Changed", 1);
    ...
    protected Double getAverageJobBudget(List<UserJob> batch){
        ...
        for(UserJob j : batch){
            sumCost += j.resourceRequest.maxNodePrice*j.resourceRequest.resourceNeed*j.resourceRequest.volume;
        }
