...
public class UserJob {
    ...
    public UserJob(int id, String name, ResourceRequest resourceRequest, VOUser user, Integer timestamp) {
        this.id = id;
        this.name = name;
    ...
    public void rankAlternatives() {
        if (rankingAlgorithm != null) {
            ...
            for (Alternative a : alternatives) {
                a.setUserRating(0);
                /* All alternatives have same rating */
            }
        }
    }
    ...
    public String debugInfo() {
        ...
        sb.append("Resource speed: " + df.format(resourceRequest.minNodePerformance) + "\n");
        sb.append("Price maximum:  " + df.format(resourceRequest.maxNodePrice) + "\n");
        if (alternatives.size() < 1) {
            ...
            for (Alternative alternative : alternatives) {
                ...
                if (alternative.window != null) {
                    ...
                    sb.append("Window start:  " + alternative.window.startTime + "\n");
            ...
            if (bestAlternative != -1 && bestAlternative < alternatives.size()) {
                ...
                sb.append("Window start:  " + alternatives.get(bestAlternative).window.startTime + "\n");
