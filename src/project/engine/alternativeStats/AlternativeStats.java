    ...
    public void addBatchToLog(ArrayList<UserJob> jobs) {
        ...
        try {
            ...
            for(UserJob job: jobs){
                newLine = ""+job.alternatives.size()+" "+job.resourceRequest.maxNodePrice+" "+
                        job.resourceRequest.resourceNeed+" "+job.resourceRequest.minNodePerformance+
