...
public class ResourceEvent extends Event {
    ...
    protected ComputingResourceLine resource;
    ...
    public ResourceEvent(int time, ComputingResourceLine resource, int type){
        super(time);
        setParams(time, resource, type, 10000, "WORKS");
    }
    
    public ResourceEvent(int time, ComputingResourceLine resource, int type, int effectDuration, String description){
        super(time);
        setParams(time, resource, type, effectDuration, description);
    }
    
    protected void setParams(int time, ComputingResourceLine resource, int type, int effectDuration, String description){
     ...
     * @return the resource
     */
    public ComputingResourceLine getResource() {
        return resource;
    }
