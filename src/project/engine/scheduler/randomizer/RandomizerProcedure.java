...
package project.engine.scheduler.randomizer;
 ...
 * @author emelyanov
 */
public class RandomizerProcedure {
    ...
    public RandomizerProcedure(SimpleSquareWindowFinder sqwFinder, int intervalStart, int intervalEnd){
