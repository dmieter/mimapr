...
public class SchedulerOperations {
    ...
    public static void stopResource(ComputingResourceLine resource, int time, ResourceEvent re) {
    ...
    public static void changeResource(VOEnvironment environment, ComputingResourceLine oldResource, ComputingResourceLine newResource, int time) {
